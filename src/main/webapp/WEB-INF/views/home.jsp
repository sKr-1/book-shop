  ...
  <div class="container">
    ...
    <div class="menu">
      <div id="home" class="menu-icon" onclick="changeMenu('home')">
        ...
        <form action="bookListUser/${user}" method="get">
      		<div class="input_box">
		        <input class="button" type="submit" style="border:none;" value="Explore">
		    </div>
        </form>
        <div class="tooltip" data-key="home">Home</div>
      </div>
      <div id="about" class="menu-icon" onclick="changeMenu('about')">
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <form action="about" method="get">
      		<div class="input_box">
		        <input class="button" type="submit" style="border:none;" value="About">
		    </div>
        </form>
      ...
      <div id="projects" class="menu-icon" onclick="changeMenu('Orders')">
        ...
        <form action="showOrderUser/${user}" method="post">
      		<div class="input_box">
      ...
      <div id="contact" class="menu-icon" onclick="changeMenu('contact')">
        ...
        <form action="register" method="get">
      		<div class="input_box">
		        <input class="button" type="submit" style="border:none;" value="Contact Us">
		    </div>
        </form>
